...
public function updateServiceStatus(Request $request, $visitId, $serviceId)
    ...
    public function index(Request $request)
    {
        ...
        $appointments = Appointment::whereHas('user', fn($q) => $q->where('branch_id', $activeBranchId))->with('pet.owner', 'services')->get();
        $prescriptions = Prescription::whereIn('user_id', $branchUserIds)->with('pet.owner')->get();
