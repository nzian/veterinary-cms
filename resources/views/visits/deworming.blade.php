    ...
    <div class="max-w-6xl mx-auto">
        ...
        <div class="bg-white rounded-lg shadow p-6 mb-6">
            <div class="flex items-center justify-between">
                ...
                <form method="POST" action="{{ route('medical.visits.deworming.save', $visit->visit_id) }}" class="flex items-center gap-2 text-xs">
                    @csrf
                    <select name="workflow_status" class="border px-2 py-1 rounded">
                        @foreach(['Waiting','Deworming Ongoing','Observation','Completed'] as $s)
            ...
            <div class="mt-3 flex items-center gap-2 text-xs">
                @foreach(['Waiting','Deworming Ongoing','Observation','Completed'] as $i => $label)
