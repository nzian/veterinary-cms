        ...
        <div class="bg-white rounded-lg shadow p-6 mb-6">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center gap-2 text-xs">
                    <span class="px-2 py-1 rounded bg-gray-100">Triage</span>
                    <span>→</span>
                    <span class="px-2 py-1 rounded bg-gray-100">Stabilization</span>
                    <span>→</span>
                    <span class="px-2 py-1 rounded bg-gray-100">Treatment</span>
                    <span>→</span>
