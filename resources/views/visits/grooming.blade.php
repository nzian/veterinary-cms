...
{{-- This modal must be present in your overall medicalManagement.blade.php or included once --}}
...
{{-- 1. Grooming Agreement Modal (CRITICAL: Full HTML and JS required for interaction) --}}
...
@push('scripts')
{{-- Ensure this script tag is present in your AdminBoard footer or layout file --}}
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        window.closeAgreementModal = function() {
            ...
            if (signaturePad) signaturePad.clear(); // Clear signature on close
        };
