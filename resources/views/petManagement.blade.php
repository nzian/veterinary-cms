...
<div id="owners-content" class="tab-content {{ request('tab', 'owners') != 'owners' ? 'hidden' : '' }}">
    ...
    document.addEventListener('DOMContentLoaded', function(){
        ...
        new ListFilter({
            ...
            searchColumns: [3, 5, 6, 9], // Pet Name, Type, Breed, Owner columns
            filterSelects: [
...
// Initialize ListFilter for each tab
document.addEventListener('DOMContentLoaded', function() {
    // Owners Tab
    new ListFilter({
        tableSelector: '#ownersTable',
        ...
        perPageSelectId: 'ownersPerPage', 
        paginationContainerId: 'ownersPagination',
        searchColumns: [1, 2, 3, 4] // Name, Email, Contact, Address columns
    });
    ...
    new ListFilter({
        ...
        searchColumns: [3, 5, 6, 9], // Pet Name, Type, Breed, Owner columns
        filterSelects: {
            'petsGender': 4, // Gender column
            'petsType': 5    // Type column  
        }
    });
});
</script>
